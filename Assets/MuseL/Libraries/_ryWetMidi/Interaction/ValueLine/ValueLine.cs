...
namespace Melanchall.DryWetMidi.Interaction
{
    ...
    public sealed class ValueLine<TValue> : IEnumerable<ValueChangeEvent<TValue>>
        where TValue : class
    {
        #region Events
        ...
        private readonly List<ValueChangeEvent<TValue>> _values = new List<ValueChangeEvent<TValue>>();
        ...
        internal void SetValue(long time, TValue value)
        {
            ...
            _values.Add(new ValueChangeEvent<TValue>(time, value));
        ...
        internal ValueLine<TValue> Reverse(long centerTime)
        {
            ...
            result._values.AddRange(values.Zip(times, (v, t) => new ValueChangeEvent<TValue>(t, v)));
        ...
        public IEnumerator<ValueChangeEvent<TValue>> GetEnumerator()
        {
            if (_valuesChanged)
            {
                _values.Sort(new TimedObjectsComparer<ValueChangeEvent<TValue>>());
