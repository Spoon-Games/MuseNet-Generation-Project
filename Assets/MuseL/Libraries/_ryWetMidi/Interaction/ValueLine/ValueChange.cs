...
namespace Melanchall.DryWetMidi.Interaction
{
    ...
    public sealed class ValueChangeEvent<TValue> : ITimedObject
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ValueChangeEvent{T}"/> with the specified
        ...
        internal ValueChangeEvent(long time, TValue value)
        {
        ...
        /// <summary>
        /// Determines if two <see cref="ValueChangeEvent{TValue}"/> objects are equal.
        /// </summary>
        /// <param name="change1">The first <see cref="ValueChangeEvent{TValue}"/> to compare.</param>
        /// <param name="change2">The second <see cref="ValueChangeEvent{TValue}"/> to compare.</param>
        /// <returns><c>true</c> if the value changes are equal, <c>false</c> otherwise.</returns>
        public static bool operator ==(ValueChangeEvent<TValue> change1, ValueChangeEvent<TValue> change2)
        {
        ...
        /// <summary>
        /// Determines if two <see cref="ValueChangeEvent{TValue}"/> objects are not equal.
        /// </summary>
        /// <param name="change1">The first <see cref="ValueChangeEvent{TValue}"/> to compare.</param>
        /// <param name="change2">The second <see cref="ValueChangeEvent{TValue}"/> to compare.</param>
        ...
        {
            return this == (obj as ValueChangeEvent<TValue>);
        }
